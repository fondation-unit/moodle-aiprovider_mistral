...
final class process_generate_text_test extends \advanced_testcase {
    ...
    protected function setUp(): void {
        ...
        // Load a response body from a fixture file.
     ...
     *
     * @param process_generate_text $processor The processor to inject the mock into.
     * @return MockHandler The mock handler to append responses to.
     */
    private function mock_guzzle_client(process_generate_text $processor): MockHandler {
    ...
    /**
     * Test create_request_object builds the correct request body.
     */
