...
final class process_explain_text_test extends \advanced_testcase {
     ...
     *
     * @param process_explain_text $processor The processor to inject the mock into.
     * @return MockHandler The mock handler to append responses to.
     */
    private function mock_guzzle_client(process_explain_text $processor): MockHandler {
    ...
    /**
     * Test create_request_object uses the core explain_text system instruction.
     */
